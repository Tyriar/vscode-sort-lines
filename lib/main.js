...
function activate(context) {
  var commands = [
    ...
    vscode.commands.registerCommand('sortLines.sortVariableLength', sortLines.variableLengthCompare),
    vscode.commands.registerCommand('sortLines.sortVariableLengthReverse', sortLines.variableLengthReverseCompare),
