...
function activate(context) {
  var commands = [
    ...
    vscode.commands.registerCommand('sortLines.sortAlphanumeric', sortLines.sortAlphanumeric),
    vscode.commands.registerCommand('sortLines.sortAlphanumericCaseInsensitive', sortLines.sortAlphanumericCaseInsensitive)
  ];
