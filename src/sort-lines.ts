...
function showDuplicates(lines: string[]): string[] {
...
const transformerSequences = {
  ...
  showDuplicateLines: [showDuplicates]
};
...
export const showDuplicateLines = () => sortActiveSelection(transformerSequences.showDuplicateLines);
